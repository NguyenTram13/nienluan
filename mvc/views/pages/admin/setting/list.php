...
<div class="container pt-3" data-aos="fade-right">
    ...
    <div class="d-flex justify-content-end gap-3">
        <p class="d-block text-end ">
            <a href="<?php echo _WEB_ROOT . '/setting/add' ?>" class="px-5 btn btn-primary">Add link</a>
        </p>
        <p class="d-block text-end ">
            <a href="<?php echo _WEB_ROOT . '/setting/addfile' ?>" class="px-5 btn btn-primary">Add file</a>
        </p>
    </div>
    <form method="POST" action="" class="form-setting">
        <div class="d-flex gap-2 mb-3">

            <input type="text" name="kyw" class="form-control setting-input" placeholder="Search...">
