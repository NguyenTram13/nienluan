            ...
            ?>
                <div class="row body-font font-Poppins">
                    <div class="col-8">
                        ...
                        <div class="cart-footer flex justify-between py-5">
                            <div class="continue">
                            ...
                            <div class="btn-right">
                                ...
                                <button class="bg-[#ccc] cursor-not-allowed text-[#888] hover:text-[#000] hover:bg-[#ccc] p-[12px] ">UPDATE CART</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-4 ">
                        <div class="border">
                            <div class="cr-title p-[30px] ">
                                ...
                                <div class="cr-center py-[28px] ">
                                    <h3 class="leading-loose text-base">Shipping</h3>
